...
add_filter('arsol_css_addons_js_addon_files', 'arsol_add_admin_enhancements_js_addon');
...
add_filter('arsol_css_addons_js_addon_files', 'arsol_add_admin_forms_js_addon');
...
add_filter('arsol_css_addons_js_addon_files', 'arsol_add_frontend_interactions_js_addon');
...
add_filter('arsol_css_addons_js_addon_files', 'arsol_add_form_validation_js_addon');
...
add_filter('arsol_css_addons_js_addon_files', 'arsol_add_smooth_scroll_js_addon');
...
add_filter('arsol_css_addons_js_addon_files', 'arsol_add_mobile_menu_js_addon');
...
add_filter('arsol_css_addons_js_addon_files', 'arsol_add_lazy_loading_js_addon');
...
add_filter('arsol_css_addons_js_addon_files', 'arsol_add_image_gallery_js_addon');
...
add_filter('arsol_css_addons_js_addon_files', 'arsol_add_search_enhancement_js_addon');
...
add_filter('arsol_css_addons_js_addon_files', 'arsol_add_cookie_consent_js_addon');