...
function arsol_add_seo_enhancements_php_addon($options) {
    $options['seo-enhancements'] = array(
        'name' => __('SEO Enhancements', 'arsol-css-addons'),
        'file' => ARSOL_CSS_ADDONS_PLUGIN_DIR . 'assets/php/addon-php/seo-enhancements.php'
    );
    return $options;
}
...
function arsol_add_performance_optimizations_php_addon($options) {
    $options['performance-optimizations'] = array(
        'name' => __('Performance Optimizations', 'arsol-css-addons'),
        'file' => ARSOL_CSS_ADDONS_PLUGIN_DIR . 'assets/php/addon-php/performance-optimizations.php'
    );
    return $options;
}
...
function arsol_add_custom_shortcodes_php_addon($options) {
    $options['custom-shortcodes'] = array(
        'name' => __('Custom Shortcodes', 'arsol-css-addons'),
        'file' => ARSOL_CSS_ADDONS_PLUGIN_DIR . 'assets/php/addon-php/custom-shortcodes.php'
    );
    return $options;
}
